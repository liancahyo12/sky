...
class JadwalHariIniDatatable extends Datatable
{
    public $slug = 'jadwal-hari-ini';
    ...
    public function datasource()
    {
        ...
        $booking = booking::leftjoin('pelanggans', 'pelanggans.id', 'pelanggan_id')->leftJoin('jenis_pakets', 'jenis_pakets.id', 'jenis_paket_id')->leftJoin('mobils', 'mobils.id', 'mobil_id')->leftJoin('wilayahs', 'wilayahs.kode', 'wilayah_id')->whereRaw("bookings.status=1 AND booking_status!=4 AND (
            ...
            (? BETWEEN awal_sewa AND akhir_sewa))", [$date.' 00:00:00', $date.' 23:59:59', $date.' 00:00:00', $date.' 23:59:59', $date.' 00:00:00', $date.' 23:59:59'])->orderByDesc('bookings.updated_at')->get([
            'bookings.id', 
            'pelanggans.nama', 
