...
RUN mkdir -p /opt/apps/sky /opt/apps/sky/bin
...
COPY --from=composer_base /opt/apps/sky /opt/apps/sky
...
COPY --from=composer_base /opt/apps/sky /opt/apps/sky
COPY --from=frontend /opt/apps/sky/public /opt/apps/sky/public
...
COPY --from=composer_base --chown=www-data /opt/apps/sky /opt/apps/sky
COPY --from=frontend --chown=www-data /opt/apps/sky/public /opt/apps/sky/public
